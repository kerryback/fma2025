...
\begin{frame}{Place in Curriculum}
 - Half-semester first-year MBA course in last half of spring semester
 - Follows core finance and half semester Excel-based Applied Finance.
 - Finance topics are mostly repeated from prior courses
    - Mean-variance optimization
    - CAPM cost of capital calculation
    - Pro forma statements and valuation
    - Mutual fund performance evaluation
    - Simulation for retirement planning
\end{frame}
\end{document}
