...
::: {.quote-box}
<span class="highlight">Claude</span> powered the first versions of our Investment Analyst Assistant, which streamlined our analysts' workflow by generating <span class="highlight">Python code</span>, creating <span class="highlight">data visualizations</span>, and iterating through <span class="highlight"> complex financial analysis tasks</span> with the precision of a junior analyst.
:::
...
## Claude $\rightarrow$ Python $\rightarrow$ Excel 
<br>
Claude prompt: Create an Excel file illustrating two-stage DCF valuation.

<br>
[Claude's Excel File](https://iita2025.kerryback.com/claude-dcf-example.xlsx)
...
On Windows: Open PowerShell, install Claude Code, type <span class="highlight">claude</span> to run.
...
## {background-video="columbo_final.webm" .has-dark-background}
...
<div class="the-end-animation">THE END</div>
...
.the-end-slide.present .the-end-animation {
  animation: fadeToDistance 6s ease-in-out forwards;
}

@keyframes fadeToDistance {
  0% {
    opacity: 1;
...
body.light-theme .reveal .slides section.the-end-slide {
  background: #000 !important;
}

.reveal .slide-background.the-end-slide {
  background: #000 !important;
}
</style>
